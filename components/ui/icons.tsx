/** Set de íconos de línea consistente (basado en Lucide, 24x24, stroke 2). */
...
export function IconCash({ size = 20, className }: IconProps) {
  return (
    <svg {...base(size)} className={className}>
