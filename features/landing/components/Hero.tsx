  ...
  return (
    <section className="relative overflow-hidden bg-white">
      ...
      <div aria-hidden="true" className="pointer-events-none absolute inset-0">
        <div className="absolute -right-24 -top-24 h-96 w-96 rounded-full bg-[#1d6fb0]/20 blur-3xl" />
        <div className="absolute -left-24 bottom-0 h-72 w-72 rounded-full bg-[#ffb347]/20 blur-3xl" />
      </div>
      ...
      <Container className="relative grid items-center gap-10 py-14 sm:py-20 lg:grid-cols-2 lg:py-24">
        <div className="text-center lg:text-left">
          ...
          <h1 className="text-4xl font-black leading-tight tracking-tight text-navy-950 sm:text-5xl lg:text-6xl">
            Especialistas en <span className="text-electric-600">pintura automotriz</span>
          </h1>
        ...
        <div className="relative order-first flex justify-center lg:order-none">
          <div className="relative">
            <div
              aria-hidden="true"
              className="absolute -inset-6 rounded-full bg-[#1d6fb0]/20 blur-3xl sm:-inset-8"
            />
            <div className="relative flex h-40 w-40 items-center justify-center overflow-hidden rounded-full border-4 border-white bg-white shadow-card sm:h-56 sm:w-56 lg:h-72 lg:w-72">
              <Image
